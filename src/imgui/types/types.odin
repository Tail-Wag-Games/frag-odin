...
Imgui_Api :: struct {
  ...
  // GetWindowPos : #type proc "c" (pOut : ^ImVec2),
  // GetWindowSize : #type proc "c" (pOut : ^ImVec2),
  ...
  // SetWindowPos_Vec2 : #type proc "c" (pos : ImVec2, cond : _c.int),
  // SetWindowSize_Vec2 : #type proc "c" (size : ImVec2, cond : _c.int),
  ...
  // SetWindowPos_Str : #type proc "c" (name : cstring, pos : ImVec2, cond : _c.int),
  // SetWindowSize_Str : #type proc "c" (name : cstring, size : ImVec2, cond : _c.int),
  // SetWindowCollapsed_Str : #type proc "c" (name : cstring, collapsed : bool, cond : _c.int),
  // SetWindowFocus_Str : #type proc "c" (name : cstring),
  // GetContentRegionAvail : #type proc "c" (pOut : ^ImVec2),
  // GetContentRegionMax : #type proc "c" (pOut : ^ImVec2),
  // GetWindowContentRegionMin : #type proc "c" (pOut : ^ImVec2),
  // GetWindowContentRegionMax : #type proc "c" (pOut : ^ImVec2),
  ...
  // PushStyleVar_Vec2 : #type proc "c" (idx : _c.int, val : ImVec2),
  ...
  // GetFontTexUvWhitePixel : #type proc "c" (pOut : ^ImVec2),
  ...
  // Button : #type proc "c" (label : cstring, size : ImVec2) -> bool,
  // SmallButton : #type proc "c" (label : cstring) -> bool,
  // InvisibleButton : #type proc "c" (str_id : cstring, size : ImVec2, flags : _c.int) -> bool,
  // ArrowButton : #type proc "c" (str_id : cstring, dir : _c.int) -> bool,
  // Image : #type proc "c" (user_texture_id : ImTextureID, size : ImVec2, uv0 : ImVec2, uv1 : ImVec2, tintcol : ImVec4, bordercol : ImVec4),
  // ImageButton : #type proc "c" (user_texture_id : ImTextureID, size : ImVec2, uv0 : ImVec2, uv1 : ImVec2, frame_padding : _c.int, bgcol : ImVec4, tintcol : ImVec4) -> bool,
  ...
  // ProgressBar : #type proc "c" (fraction : _c.float, size_arg : ImVec2, overlay : cstring),
  // Bullet : #type proc "c" (),
  ...
  // VSliderFloat : #type proc "c" (label : cstring, size : ImVec2, v : ^_c.float, v_min : _c.float, v_max : _c.float, format : cstring, flags : _c.int) -> bool,
  // VSliderInt : #type proc "c" (label : cstring, size : ImVec2, v : ^_c.int, v_min : _c.int, v_max : _c.int, format : cstring, flags : _c.int) -> bool,
  // VSliderScalar : #type proc "c" (label : cstring, size : ImVec2, data_type : _c.int, p_data : rawptr, p_min : rawptr, p_max : rawptr, format : cstring, flags : _c.int) -> bool,
  ...
  // InputTextMultiline : #type proc "c" (label : cstring, buf : cstring, buf_size : _c.size_t, size : ImVec2, flags : _c.int, callback : ImGuiInputTextCallback, user_data : rawptr) -> bool,
  ...
  // ColorButton : #type proc "c" (desc_id : cstring, col : ImVec4, flags : _c.int, size : ImVec2) -> bool,
  ...
  // Selectablebool : #type proc "c" (label : cstring, selected : bool, flags : _c.int, size : ImVec2) -> bool,
  // SelectableboolPtr : #type proc "c" (label : cstring, p_selected : ^bool, flags : _c.int, size : ImVec2) -> bool,
  // BeginListBox : #type proc "c" (label : cstring, size : ImVec2) -> bool,
  ...
  // PlotLines_FloatPtr : #type proc "c" (label : cstring, values : ^_c.float, valuescount : _c.int, values_offset : _c.int, overlay_text : cstring, scale_min : _c.float, scale_max : _c.float, graph_size : ImVec2, stride : _c.int),
  // PlotLines_FnFloatPtr : #type proc "c" (label : cstring, unamed0 : #type proc "c" (data : rawptr, idx : _c.int) -> _c.float, data : rawptr, valuescount : _c.int, values_offset : _c.int, overlay_text : cstring, scale_min : _c.float, scale_max : _c.float, graph_size : ImVec2),
  // PlotHistogram_FloatPtr : #type proc "c" (label : cstring, values : ^_c.float, valuescount : _c.int, values_offset : _c.int, overlay_text : cstring, scale_min : _c.float, scale_max : _c.float, graph_size : ImVec2, stride : _c.int),
  // PlotHistogram_FnFloatPtr : #type proc "c" (label : cstring, unamed0 : #type proc "c" (data : rawptr, idx : _c.int) -> _c.float, data : rawptr, valuescount : _c.int, values_offset : _c.int, overlay_text : cstring, scale_min : _c.float, scale_max : _c.float, graph_size : ImVec2),
  ...
  // BeginTable : #type proc "c" (str_id : cstring, column : _c.int, flags : _c.int, outer_size : ImVec2, inner_width : _c.float) -> bool,
  ...
  // DockSpace : #type proc "c" (id : _c.uint, size : ImVec2, flags : _c.int, windowclass : ^ImGuiWindowClass),
  ...
  // PushClipRect : #type proc "c" (clip_rect_min : ImVec2, clip_rect_max : ImVec2, intersect_withcurrentclip_rect : bool),
  ...
  // GetItemRectMin : #type proc "c" (pOut : ^ImVec2),
  // GetItemRectMax : #type proc "c" (pOut : ^ImVec2),
  // GetItemRectSize : #type proc "c" (pOut : ^ImVec2),
  // SetItemAllowOverlap : #type proc "c" (),
  // GetMainViewport : #type proc "c" () -> ^ImGuiViewport,
  // IsRectVisible_Nil : #type proc "c" (size : ImVec2) -> bool,
  // IsRectVisible_Vec2 : #type proc "c" (rect_min : ImVec2, rect_max : ImVec2) -> bool,
  ...
  // BeginChildFrame : #type proc "c" (id : _c.uint, size : ImVec2, flags : _c.int) -> bool,
  // EndChildFrame : #type proc "c" (),
  // CalcTextSize : #type proc "c" (pOut : ^ImVec2, text : cstring, text_end : cstring, hide_text_after_double_hash : bool, wrap_width : _c.float),
  ...
  // IsMouseHoveringRect : #type proc "c" (r_min : ImVec2, r_max : ImVec2, clip : bool) -> bool,
  // IsMousePosValid : #type proc "c" (mouse_pos : ^ImVec2) -> bool,
  // IsAnyMouseDown : #type proc "c" () -> bool,
  // GetMousePos : #type proc "c" (pOut : ^ImVec2),
  // GetMousePosOnOpeningCurrentPopup : #type proc "c" (pOut : ^ImVec2),
  // IsMouseDragging : #type proc "c" (button : _c.int, lock_threshold : _c.float) -> bool,
  // GetMouseDragDelta : #type proc "c" (pOut : ^ImVec2, button : _c.int, lock_threshold : _c.float),
  ...
  // ImMin : #type proc "c" (pOut : ^ImVec2, lhs : ImVec2, rhs : ImVec2),
  // ImMax : #type proc "c" (pOut : ^ImVec2, lhs : ImVec2, rhs : ImVec2),
  // ImClamp : #type proc "c" (pOut : ^ImVec2, v : ImVec2, mn : ImVec2, mx : ImVec2),
  // ImLerp_Vec2Float : #type proc "c" (pOut : ^ImVec2, a : ImVec2, b : ImVec2, t : _c.float),
  // ImLerp_Vec2Vec2 : #type proc "c" (pOut : ^ImVec2, a : ImVec2, b : ImVec2, t : ImVec2),
  // ImLerp_Vec4 : #type proc "c" (pOut : ^ImVec4, a : ImVec4, b : ImVec4, t : _c.float),
  // ImSaturate : #type proc "c" (f : _c.float) -> _c.float,
  // ImLengthSqr_Vec2 : #type proc "c" (lhs : ImVec2) -> _c.float,
  // ImLengthSqr_Vec4 : #type proc "c" (lhs : ImVec4) -> _c.float,
  // ImInvLength : #type proc "c" (lhs : ImVec2, fail_value : _c.float) -> _c.float,
  // ImFloor_Float : #type proc "c" (f : _c.float) -> _c.float,
  // ImFloor_Vec2 : #type proc "c" (pOut : ^ImVec2, v : ImVec2),
  // ImModPositive : #type proc "c" (a : _c.int, b : _c.int) -> _c.int,
  // ImDot : #type proc "c" (a : ImVec2, b : ImVec2) -> _c.float,
  // ImRotate : #type proc "c" (pOut : ^ImVec2, v : ImVec2, cos_a : _c.float, sin_a : _c.float),
  // ImLinearSweep : #type proc "c" (current : _c.float, target : _c.float, speed : _c.float) -> _c.float,
  // ImMul : #type proc "c" (pOut : ^ImVec2, lhs : ImVec2, rhs : ImVec2),
  // ImBezierCubicCalc : #type proc "c" (pOut : ^ImVec2, p1 : ImVec2, p2 : ImVec2, p3 : ImVec2, p4 : ImVec2, t : _c.float),
  // ImBezierCubicClosestPoint : #type proc "c" (pOut : ^ImVec2, p1 : ImVec2, p2 : ImVec2, p3 : ImVec2, p4 : ImVec2, p : ImVec2, num_segments : _c.int),
  // ImBezierCubicClosestPointCasteljau : #type proc "c" (pOut : ^ImVec2, p1 : ImVec2, p2 : ImVec2, p3 : ImVec2, p4 : ImVec2, p : ImVec2, tess_tol : _c.float),
  // ImBezierQuadraticCalc : #type proc "c" (pOut : ^ImVec2, p1 : ImVec2, p2 : ImVec2, p3 : ImVec2, t : _c.float),
  // ImLineClosestPoint : #type proc "c" (pOut : ^ImVec2, a : ImVec2, b : ImVec2, p : ImVec2),
  // ImTriangleContainsPoint : #type proc "c" (a : ImVec2, b : ImVec2, c : ImVec2, p : ImVec2) -> bool,
  // ImTriangleClosestPoint : #type proc "c" (pOut : ^ImVec2, a : ImVec2, b : ImVec2, c : ImVec2, p : ImVec2),
  // ImTriangleBarycentricCoords : #type proc "c" (a : ImVec2, b : ImVec2, c : ImVec2, p : ImVec2, out_u : ^_c.float, out_v : ^_c.float, out_w : ^_c.float),
  // ImTriangleArea : #type proc "c" (a : ImVec2, b : ImVec2, c : ImVec2) -> _c.float,
  ...
  // CalcWindowNextAutoFitSize : #type proc "c" (pOut : ^ImVec2, window : ^ImGuiWindow),
  ...
  // SetWindowPos_WindowPtr : #type proc "c" (window : ^ImGuiWindow, pos : ImVec2, cond : _c.int),
  // SetWindowSize_WindowPtr : #type proc "c" (window : ^ImGuiWindow, size : ImVec2, cond : _c.int),
  // SetWindowCollapsed_WindowPtr : #type proc "c" (window : ^ImGuiWindow, collapsed : bool, cond : _c.int),
  // SetWindowHitTestHole : #type proc "c" (window : ^ImGuiWindow, pos : ImVec2, size : ImVec2),
  ...
  // TranslateWindowsInViewport : #type proc "c" (viewport : ^ImGuiViewportP, old_pos : ImVec2, new_pos : ImVec2),
  ...
  // SetNextWindowScroll : #type proc "c" (scroll : ImVec2),
  ...
  // ScrollToBringRectIntoView : #type proc "c" (pOut : ^ImVec2, window : ^ImGuiWindow, item_rect : ImRect),
  ...
  // ItemSize_Vec2 : #type proc "c" (size : ImVec2, text_baseline_y : _c.float),
  ...
  // CalcItemSize : #type proc "c" (pOut : ^ImVec2, size : ImVec2, default_w : _c.float, default_h : _c.float),
  // CalcWrapWidthForPos : #type proc "c" (pos : ImVec2, wrap_pos_x : _c.float) -> _c.float,
  ...
  // GetContentRegionMaxAbs : #type proc "c" (pOut : ^ImVec2),
  ...
  // LogRenderedText : #type proc "c" (ref_pos : ^ImVec2, text : cstring, text_end : cstring),
  // LogSetNextTextDecoration : #type proc "c" (prefix : cstring, suffix : cstring),
  // BeginChildEx : #type proc "c" (name : cstring, id : _c.uint, size_arg : ImVec2, border : bool, flags : _c.int) -> bool,
  ...
  // FindBestWindowPosForPopup : #type proc "c" (pOut : ^ImVec2, window : ^ImGuiWindow),
  // FindBestWindowPosForPopupEx : #type proc "c" (pOut : ^ImVec2, ref_pos : ImVec2, size : ImVec2, last_dir : ^_c.int, r_outer : ImRect, r_avoid : ImRect, policy : ImGuiPopupPositionPolicy),
  ...
  // GetNavInputAmount2d : #type proc "c" (pOut : ^ImVec2, dir_sources : _c.int, mode : ImGuiInputReadMode, slow_factor : _c.float, fast_factor : _c.float),
  ...
  // DockContextCalcDropPosForDocking : #type proc "c" (target : ^ImGuiWindow, target_node : ^ImGuiDockNode, payload : ^ImGuiWindow, split_dir : _c.int, split_outer : bool, out_pos : ^ImVec2) -> bool,
  ...
  // DockBuilderSetNodePos : #type proc "c" (node_id : _c.uint, pos : ImVec2),
  // DockBuilderSetNodeSize : #type proc "c" (node_id : _c.uint, size : ImVec2),
  ...
  // BeginTableEx : #type proc "c" (name : cstring, id : _c.uint, columnscount : _c.int, flags : _c.int, outer_size : ImVec2, inner_width : _c.float) -> bool,
  ...
  // TabItemCalcSize : #type proc "c" (pOut : ^ImVec2, label : cstring, hasclose_button : bool),
  // TabItemBackground : #type proc "c" (draw_list : ^ImDrawList, bb : ImRect, flags : _c.int, col : _c.uint),
  // TabItemLabelAndCloseButton : #type proc "c" (draw_list : ^ImDrawList, bb : ImRect, flags : _c.int, frame_padding : ImVec2, label : cstring, tab_id : _c.uint, close_button_id : _c.uint, iscontents_visible : bool, out_justclosed : ^bool, out_textclipped : ^bool),
  // RenderText : #type proc "c" (pos : ImVec2, text : cstring, text_end : cstring, hide_text_after_hash : bool),
  // RenderTextWrapped : #type proc "c" (pos : ImVec2, text : cstring, text_end : cstring, wrap_width : _c.float),
  // RenderTextClipped : #type proc "c" (pos_min : ImVec2, pos_max : ImVec2, text : cstring, text_end : cstring, text_size_if_known : ^ImVec2, align : ImVec2, clip_rect : ^ImRect),
  // RenderTextClippedEx : #type proc "c" (draw_list : ^ImDrawList, pos_min : ImVec2, pos_max : ImVec2, text : cstring, text_end : cstring, text_size_if_known : ^ImVec2, align : ImVec2, clip_rect : ^ImRect),
  // RenderTextEllipsis : #type proc "c" (draw_list : ^ImDrawList, pos_min : ImVec2, pos_max : ImVec2, clip_max_x : _c.float, ellipsis_max_x : _c.float, text : cstring, text_end : cstring, text_size_if_known : ^ImVec2),
  // RenderFrame : #type proc "c" (p_min : ImVec2, p_max : ImVec2, fillcol : _c.uint, border : bool, rounding : _c.float),
  // RenderFrameBorder : #type proc "c" (p_min : ImVec2, p_max : ImVec2, rounding : _c.float),
  // RenderColorRectWithAlphaCheckerboard : #type proc "c" (draw_list : ^ImDrawList, p_min : ImVec2, p_max : ImVec2, fillcol : _c.uint, grid_step : _c.float, grid_off : ImVec2, rounding : _c.float, flags : _c.int),
  ...
  // RenderArrow : #type proc "c" (draw_list : ^ImDrawList, pos : ImVec2, col : _c.uint, dir : _c.int, scale : _c.float),
  // RenderBullet : #type proc "c" (draw_list : ^ImDrawList, pos : ImVec2, col : _c.uint),
  // RenderCheckMark : #type proc "c" (draw_list : ^ImDrawList, pos : ImVec2, col : _c.uint, sz : _c.float),
  // RenderMouseCursor : #type proc "c" (draw_list : ^ImDrawList, pos : ImVec2, scale : _c.float, mousecursor : _c.int, col_fill : _c.uint, col_border : _c.uint, col_shadow : _c.uint),
  // RenderArrowPointingAt : #type proc "c" (draw_list : ^ImDrawList, pos : ImVec2, half_sz : ImVec2, direction : _c.int, col : _c.uint),
  // RenderArrowDockMenu : #type proc "c" (draw_list : ^ImDrawList, p_min : ImVec2, sz : _c.float, col : _c.uint),
  ...
  // ButtonEx : #type proc "c" (label : cstring, size_arg : ImVec2, flags : _c.int) -> bool,
  // CloseButton : #type proc "c" (id : _c.uint, pos : ImVec2) -> bool,
  // CollapseButton : #type proc "c" (id : _c.uint, pos : ImVec2, dock_node : ^ImGuiDockNode) -> bool,
  // ArrowButtonEx : #type proc "c" (str_id : cstring, dir : _c.int, size_arg : ImVec2, flags : _c.int) -> bool,
  ...
  // ImageButtonEx : #type proc "c" (id : _c.uint, texture_id : ImTextureID, size : ImVec2, uv0 : ImVec2, uv1 : ImVec2, padding : ImVec2, bgcol : ImVec4, tintcol : ImVec4) -> bool,
  ...
  // InputTextEx : #type proc "c" (label : cstring, hint : cstring, buf : cstring, buf_size : _c.int, size_arg : ImVec2, flags : _c.int, callback : ImGuiInputTextCallback, user_data : rawptr) -> bool,
  ...
  // PlotEx : #type proc "c" (plot_type : ImGuiPlotType, label : cstring, unamed0 : #type proc "c" (data : rawptr, idx : _c.int) -> _c.float, data : rawptr, valuescount : _c.int, values_offset : _c.int, overlay_text : cstring, scale_min : _c.float, scale_max : _c.float, frame_size : ImVec2) -> _c.int,
  // ShadeVertsLinearColorGradientKeepAlpha : #type proc "c" (draw_list : ^ImDrawList, vert_start_idx : _c.int, vert_end_idx : _c.int, gradient_p0 : ImVec2, gradient_p1 : ImVec2, col0 : _c.uint, col1 : _c.uint),
  // ShadeVertsLinearUV : #type proc "c" (draw_list : ^ImDrawList, vert_start_idx : _c.int, vert_end_idx : _c.int, a : ImVec2, b : ImVec2, uv_a : ImVec2, uv_b : ImVec2, clamp : bool),
  ...
  // ImDrawList_PushClipRect : #type proc "c" (self : ^ImDrawList, clip_rect_min : ImVec2, clip_rect_max : ImVec2, intersect_withcurrentclip_rect : bool),
  ...
  // ImDrawList_GetClipRectMin : #type proc "c" (pOut : ^ImVec2, self : ^ImDrawList),
  // ImDrawList_GetClipRectMax : #type proc "c" (pOut : ^ImVec2, self : ^ImDrawList),
  // ImDrawList_AddLine : #type proc "c" (self : ^ImDrawList, p1 : ImVec2, p2 : ImVec2, col : _c.uint, thickness : _c.float),
  // ImDrawList_AddRect : #type proc "c" (self : ^ImDrawList, p_min : ImVec2, p_max : ImVec2, col : _c.uint, rounding : _c.float, flags : _c.int, thickness : _c.float),
  // ImDrawList_AddRectFilled : #type proc "c" (self : ^ImDrawList, p_min : ImVec2, p_max : ImVec2, col : _c.uint, rounding : _c.float, flags : _c.int),
  // ImDrawList_AddRectFilledMultiColor : #type proc "c" (self : ^ImDrawList, p_min : ImVec2, p_max : ImVec2, col_upr_left : _c.uint, col_upr_right : _c.uint, col_bot_right : _c.uint, col_bot_left : _c.uint),
  // ImDrawList_AddQuad : #type proc "c" (self : ^ImDrawList, p1 : ImVec2, p2 : ImVec2, p3 : ImVec2, p4 : ImVec2, col : _c.uint, thickness : _c.float),
  // ImDrawList_AddQuadFilled : #type proc "c" (self : ^ImDrawList, p1 : ImVec2, p2 : ImVec2, p3 : ImVec2, p4 : ImVec2, col : _c.uint),
  // ImDrawList_AddTriangle : #type proc "c" (self : ^ImDrawList, p1 : ImVec2, p2 : ImVec2, p3 : ImVec2, col : _c.uint, thickness : _c.float),
  // ImDrawList_AddTriangleFilled : #type proc "c" (self : ^ImDrawList, p1 : ImVec2, p2 : ImVec2, p3 : ImVec2, col : _c.uint),
  // ImDrawList_AddCircle : #type proc "c" (self : ^ImDrawList, center : ImVec2, radius : _c.float, col : _c.uint, num_segments : _c.int, thickness : _c.float),
  // ImDrawList_AddCircleFilled : #type proc "c" (self : ^ImDrawList, center : ImVec2, radius : _c.float, col : _c.uint, num_segments : _c.int),
  // ImDrawList_AddNgon : #type proc "c" (self : ^ImDrawList, center : ImVec2, radius : _c.float, col : _c.uint, num_segments : _c.int, thickness : _c.float),
  // ImDrawList_AddNgonFilled : #type proc "c" (self : ^ImDrawList, center : ImVec2, radius : _c.float, col : _c.uint, num_segments : _c.int),
  // ImDrawList_AddText_Vec2 : #type proc "c" (self : ^ImDrawList, pos : ImVec2, col : _c.uint, text_begin : cstring, text_end : cstring),
  // ImDrawList_AddText_FontPtr : #type proc "c" (self : ^ImDrawList, font : ^ImFont, font_size : _c.float, pos : ImVec2, col : _c.uint, text_begin : cstring, text_end : cstring, wrap_width : _c.float, cpu_fineclip_rect : ^ImVec4),
  // ImDrawList_AddPolyline : #type proc "c" (self : ^ImDrawList, points : ^ImVec2, num_points : _c.int, col : _c.uint, flags : _c.int, thickness : _c.float),
  // ImDrawList_AddConvexPolyFilled : #type proc "c" (self : ^ImDrawList, points : ^ImVec2, num_points : _c.int, col : _c.uint),
  // ImDrawList_AddBezierCubic : #type proc "c" (self : ^ImDrawList, p1 : ImVec2, p2 : ImVec2, p3 : ImVec2, p4 : ImVec2, col : _c.uint, thickness : _c.float, num_segments : _c.int),
  // ImDrawList_AddBezierQuadratic : #type proc "c" (self : ^ImDrawList, p1 : ImVec2, p2 : ImVec2, p3 : ImVec2, col : _c.uint, thickness : _c.float, num_segments : _c.int),
  // ImDrawList_AddImage : #type proc "c" (self : ^ImDrawList, user_texture_id : ImTextureID, p_min : ImVec2, p_max : ImVec2, uv_min : ImVec2, uv_max : ImVec2, col : _c.uint),
  // ImDrawList_AddImageQuad : #type proc "c" (self : ^ImDrawList, user_texture_id : ImTextureID, p1 : ImVec2, p2 : ImVec2, p3 : ImVec2, p4 : ImVec2, uv1 : ImVec2, uv2 : ImVec2, uv3 : ImVec2, uv4 : ImVec2, col : _c.uint),
  // ImDrawList_AddImageRounded : #type proc "c" (self : ^ImDrawList, user_texture_id : ImTextureID, p_min : ImVec2, p_max : ImVec2, uv_min : ImVec2, uv_max : ImVec2, col : _c.uint, rounding : _c.float, flags : _c.int),
  // ImDrawList_PathClear : #type proc "c" (self : ^ImDrawList),
  // ImDrawList_PathLineTo : #type proc "c" (self : ^ImDrawList, pos : ImVec2),
  // ImDrawList_PathLineToMergeDuplicate : #type proc "c" (self : ^ImDrawList, pos : ImVec2),
  ...
  // ImDrawList_PathArcTo : #type proc "c" (self : ^ImDrawList, center : ImVec2, radius : _c.float, a_min : _c.float, a_max : _c.float, num_segments : _c.int),
  // ImDrawList_PathArcToFast : #type proc "c" (self : ^ImDrawList, center : ImVec2, radius : _c.float, a_min_of_12 : _c.int, a_max_of_12 : _c.int),
  // ImDrawList_PathBezierCubicCurveTo : #type proc "c" (self : ^ImDrawList, p2 : ImVec2, p3 : ImVec2, p4 : ImVec2, num_segments : _c.int),
  // ImDrawList_PathBezierQuadraticCurveTo : #type proc "c" (self : ^ImDrawList, p2 : ImVec2, p3 : ImVec2, num_segments : _c.int),
  // ImDrawList_PathRect : #type proc "c" (self : ^ImDrawList, rect_min : ImVec2, rect_max : ImVec2, rounding : _c.float, flags : _c.int),
  ...
  // ImDrawList_PrimRect : #type proc "c" (self : ^ImDrawList, a : ImVec2, b : ImVec2, col : _c.uint),
  // ImDrawList_PrimRectUV : #type proc "c" (self : ^ImDrawList, a : ImVec2, b : ImVec2, uv_a : ImVec2, uv_b : ImVec2, col : _c.uint),
  // ImDrawList_PrimQuadUV : #type proc "c" (self : ^ImDrawList, a : ImVec2, b : ImVec2, c : ImVec2, d : ImVec2, uv_a : ImVec2, uv_b : ImVec2, uvc : ImVec2, uv_d : ImVec2, col : _c.uint),
  // ImDrawList_PrimWriteVtx : #type proc "c" (self : ^ImDrawList, pos : ImVec2, uv : ImVec2, col : _c.uint),
  // ImDrawList_PrimWriteIdx : #type proc "c" (self : ^ImDrawList, idx : _c.ushort),
  // ImDrawList_PrimVtx : #type proc "c" (self : ^ImDrawList, pos : ImVec2, uv : ImVec2, col : _c.uint),
  ...
  // ImDrawList__PathArcToFastEx : #type proc "c" (self : ^ImDrawList, center : ImVec2, radius : _c.float, a_min_sample : _c.int, a_max_sample : _c.int, a_step : _c.int),
  // ImDrawList__PathArcToN : #type proc "c" (self : ^ImDrawList, center : ImVec2, radius : _c.float, a_min : _c.float, a_max : _c.float, num_segments : _c.int),
  ...
  // ImFont_CalcTextSizeA : #type proc "c" (pOut : ^ImVec2, self : ^ImFont, size : _c.float, max_width : _c.float, wrap_width : _c.float, text_begin : cstring, text_end : cstring, remaining : ^cstring),
  ...
  // ImFont_RenderChar : #type proc "c" (self : ^ImFont, draw_list : ^ImDrawList, size : _c.float, pos : ImVec2, col : _c.uint, c : _c.ushort),
  // ImFont_RenderText : #type proc "c" (self : ^ImFont, draw_list : ^ImDrawList, size : _c.float, pos : ImVec2, col : _c.uint, clip_rect : ImVec4, text_begin : cstring, text_end : cstring, wrap_width : _c.float, cpu_fineclip : bool),
  ...
  // ImFontAtlas_AddFontFromMemoryCompressedTTF : #type proc "c" (self : ^ImFontAtlas, compressed_font_data : rawptr, compressed_font_size : _c.int, size_pixels : _c.float, fontcfg : ^ImFontConfig, glyph_ranges : ^_c.ushort) -> ^ImFont,
  ...
  // ImFontAtlas_GetTexDataAsRGBA32 : #type proc "c" (self : ^ImFontAtlas, out_pixels : ^^_c.uchar, out_width : ^_c.int, out_height : ^_c.int, out_bytes_per_pixel : ^_c.int),
  ...
  // ImFontAtlas_AddCustomRectFontGlyph : #type proc "c" (self : ^ImFontAtlas, font : ^ImFont, id : _c.ushort, width : _c.int, height : _c.int, advance_x : _c.float, offset : ImVec2) -> _c.int,
  // ImFontAtlas_GetCustomRectByIndex : #type proc "c" (self : ^ImFontAtlas, index : _c.int) -> ^ImFontAtlasCustomRect,
  // ImFontAtlas_CalcCustomRectUV : #type proc "c" (self : ^ImFontAtlas, rect : ^ImFontAtlasCustomRect, out_uv_min : ^ImVec2, out_uv_max : ^ImVec2),
  // ImFontAtlas_GetMouseCursorTexData : #type proc "c" (self : ^ImFontAtlas, cursor : _c.int, out_offset : ^ImVec2, out_size : ^ImVec2, out_uv_border : [2]ImVec2, out_uv_fill : [2]ImVec2) -> bool,
